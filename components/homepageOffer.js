    ...
    <>
      ...
      >
        ...
        <div className="order-1 mb-5 md:w-1/2 md:order-2">
          <h2 className="text-2xl md:text-[32px] font-bold mb-4 md:mb-7">
            Bądź widoczny dla <span className="text-mz-default">klientów</span>.
          </h2>
          <p className="mb-4 md:text-[19px]">
            <span className="font-medium">
              Nikt nie słyszał o Twojej firmie?
            </span>{" "}
            <span className="font-medium text-mz-default">
              Masz mało klientów?{" "}
            </span>
            <span className="block">
              Dzieje się tak przez brak strony internetowej.
            </span>
          </p>
          <p className="mb-4 md:text-[19px]">
            <span className="text-mz-default">
              Wyjdź swoim klientom na przeciw
            </span>
            , promuj swoją firmę,{" "}
            <span className="block">
              docieraj do klientów z drugiego końca Polski.
            </span>
          </p>

          <p className="md:text-[19px]">
            <span className="font-medium">Strona internetowa</span> pracuje dla
            Ciebie przez całą dobę.
          </p>
        </div>
      </Container>
      ...
      <Container classes="md:flex justify-between items-center md:py-20">
        <div className="md:w-7/12 mb-10 md:mb-0">
          ...
          <p className="mb-4 md:text-[19px]">
            Strona internetowa to nie tylko wygląd.{" "}
      ...
      <Container classes="pb-10 md:pb-20">
        ...
        <div className="md:grid grid-cols-3 gap-4">
          ...
          <div className="mb-5 md:mb-0 rounded-[10px] p-4 md:p-6 border border-dashed border-mz-default">
            ...
            <p>
              Odpowiedni hosting to gwarancja szybkiej strony internetowej. Bądź
          ...
          <div className="mb-5 md:mb-0 rounded-[10px] p-4 md:p-6 border border-dashed border-mz-default">
            ...
            <p>
              Zapewnij bezpieczeństwo swoim klientom poprzez certyfikat SSL.
          ...
          <div className="mb-5 md:mb-0 rounded-[10px] p-4 md:p-6 border border-dashed border-mz-secondary">
            ...
            <p>
              Zapomnij o WordPressie, tworzę strony 10 razy szybsze i
              bezpieczniejsze dzięki wykorzystaniu JAMstack.
            </p>
          </div>
          <div className="mb-5 md:mb-0 rounded-[10px] p-4 md:p-6 border border-dashed border-mz-secondary">
            <h3 className="text-[20px] md:text-[25px] mb-2 text-mz-secondary font-bold text-center">
            ...
            <p>
              Zarządzaj swoją stroną samodzielnie, intuicyjny system zarządzania
              treścią dopasowany do Twoich potrzeb.
            </p>
          </div>
          <div className="mb-5 md:mb-0 rounded-[10px] p-4 md:p-6 border border-dashed border-mz-secondary">
            <h3 className="text-[20px] md:text-[25px] mb-2 text-mz-secondary font-bold text-center">
            ...
            <p>
              Masz pytanie? Czegoś nie wiesz? Jestem tutaj, aby Ci pomóc i
